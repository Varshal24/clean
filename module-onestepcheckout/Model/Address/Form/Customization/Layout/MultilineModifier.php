...
class MultilineModifier
{
    ...
    public function modify($rowLayout, $addressType)
    {
        ...
        if (isset($formConfig['attributes']['street'])) {
            ...
            if (!isset($streetAttribute[0])) {
                unset($streetAttribute);
                $streetAttribute[0] = $formConfig['attributes']['street'];
                unset($formConfig['attributes']['street']);
                $formConfig['attributes']['street'] = $streetAttribute;
            }
