...
class CheckoutTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->layoutProcessorProviderMock = $this->getMockBuilder(LayoutProcessorProvider::class)
            ...
            ->getMock();
        $this->serializer = $objectManager->getObject(Json::class);
    ...
    public function testGetJsLayout()
    {
        ...
        $this->assertEquals($this->serializer->serialize($modifiedJsLayout), $this->block->getJsLayout());
    }
    ...
    public function testGetSerializedCheckoutConfig()
    {
        ...
        $this->configProviderMock->expects($this->once())
            ->method('getConfig')
            ->willReturn($config);
        $this->assertEquals($this->serializer->serialize($config), $this->block->getSerializedCheckoutConfig());
    }
}
