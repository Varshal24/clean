define(
    ...
    function (
        ...
        return function (sections, useCache, messageContainer) {
            ...
            if (cache && Object.keys(cache).length > 0 && useCache) {
                ...
                if (!customer.isLoggedIn()) {
                    ...
                    if (window.checkoutConfig.negotiableQuoteId !== undefined) {
                        serviceUrl = urlBuilder.createUrl('/awOsc/negotiable-carts/:cartId/sections-details', {
                            cartId: window.checkoutConfig.negotiableQuoteId
                        });
                    } else {
                ...
                return storage.post(
                    ...
                    function (response) {
                        ...
                        if (Object.keys(response).length >= minSectionsLengthForCached) {
