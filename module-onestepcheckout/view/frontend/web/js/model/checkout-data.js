    ...
    function ($, customerData, checkoutData) {
        ...
        if ($.isEmptyObject(getData())) {
            var oscCheckoutData = {
                ...
                'sameAsBillingFlag': window.checkoutConfig.sameAsShippingFlag,
                'addressTypeToDisplayFirst': window.checkoutConfig.addressTypeToDisplayFirst,
        ...
        return {
             ...
             * @returns {boolean}
             */
            getSameAsBillingFlag: function () {
                return getData().sameAsBillingFlag;
            },
             ...
             * @param {boolean} flag
             */
            setSameAsBillingFlag: function (flag) {
                var obj = getData();

                obj.sameAsBillingFlag = flag;
                saveData(obj);
            },
            ...
            /**
             * Get address type to display first value
             *
             * @returns {string}
             */
            getAddressTypeToDisplayFirst: function () {
                return getData().addressTypeToDisplayFirst;
            },

            /**
             * Set address type to display first value
             *
             * @param {string} value
             */
            setAddressTypeToDisplayFirst: function (value) {
                var obj = getData();

                obj.addressTypeToDisplayFirst = value;
                saveData(obj);
            },
            ...
            resetAwCheckoutData: function () {
                var oscCheckoutData = {
                    'sameAsShippingFlag': window.checkoutConfig.sameAsShippingFlag && window.checkoutConfig.addressTypeToDisplayFirst == 'shipping',
                    'sameAsBillingFlag': window.checkoutConfig.sameAsShippingFlag && window.checkoutConfig.addressTypeToDisplayFirst == 'billing',
                    'addressTypeToDisplayFirst': window.checkoutConfig.addressTypeToDisplayFirst,
                    'isSubscribedFlag': null,
                    'orderNote': null,
                    'deliveryDateFormData': null
