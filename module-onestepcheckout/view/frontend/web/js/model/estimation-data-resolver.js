        ...
        return {
            ...
            resolveShippingAddress: function () {
                ...
                if (addressList().length == 0
                    || addressFormState.isShippingFormOpened()
                    || addressFormState.isShippingNewFormOpened()
                ) {
                    shippingAddress = this.resolveShippingAddressFormData();
                } else if (!addressFormState.isShippingNewFormOpened()) {
            ...
            resolveBillingAddress: function () {
                var isNeedResolveFormData = addressList().length == 0
                || addressFormState.isBillingFormOpened()
                || addressFormState.isBillingNewFormOpened(),
                    billingAddress = isNeedResolveFormData
