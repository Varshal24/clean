define(
    ...
    function ($, _, utils, floatLabelConvertersPool, ko) {
        'use strict';

        return {
            isRenderButtonDefault: ko.observable(false),
            paymentMethodItemsSelectors: '[data-role=payment-methods-load] div.payment-method',
            actionsToolbarSelector: 'div.actions-toolbar .action.primary.checkout',
