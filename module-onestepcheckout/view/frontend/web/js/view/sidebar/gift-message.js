define([
...
], function (_, Component, registry, utils, giftMessageService, giftWrappingService, giftMessageAction) {
    'use strict';
    ...
    return Component.extend({
        ...
        deleteOptions: function () {
            ...
            data = _.mapObject(data, function(value, key) {
        ...
        _getGiftMessageData: function () {
            var scope = this.dataScope,
                params = this.source.get(scope) ? this.source.get(scope) : {};

            var params = this._attachGiftWrappingData(params);

            return params;
        },

        /**
         * Attach gift wrapping data to params
         * @param {Object} params
         * @returns {Object}
         * @private
         */
        _attachGiftWrappingData: function(params) {
            var giftWrappingParams = giftWrappingService.getOptionByLevel(this._getActionItemId());

            if (_.isObject(giftWrappingParams) && _.size(giftWrappingParams)) {
                params['extension_attributes'] = giftWrappingParams;
            }
